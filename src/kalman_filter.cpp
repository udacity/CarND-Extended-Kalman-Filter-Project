...
void KalmanFilter::Predict() {
    ...
    */
    ...
    // u is dropped because the process noise has a zero mean.
    x_ = F_ * x_;
...
void KalmanFilter::Update(const VectorXd &z) {
    ...
    */
    ...
    // updated this part of the code to have 4 multiplication (*) instead of 5
    VectorXd y = z - H_ * x_;
...
void KalmanFilter::UpdateEKF(const VectorXd &z) {
    ...
    */
    ...
    // updated this part of the code to have 3 multiplication (*) instead of 4
    VectorXd y = z - hx;
    MatrixXd Ht = H_.transpose();
    MatrixXd PHt = P_ * Ht;
    MatrixXd S = H_ * PHt + R_;
